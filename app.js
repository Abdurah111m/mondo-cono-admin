...
async function api(path, { method="GET", body, raw=false } = {}){
  ...
  let opts = { method, headers, cache: "no-store" };
  ...
  // Keshni chetlab o'tish: GET so'rovlarga vaqt belgisi qo'shamiz (Telegram brauzeri eski ro'yxatni saqlamasligi uchun)
  let url = API + path;
...
/* ============================================================
   KATALOG IMPORT — rasmiy narx ro'yxati (New_Price) asosida
   ============================================================ */
const CATALOG = [
  { c:{name_uz:"Eskimo", name_ru:"Эскимо", emoji:"🍫"}, p:[
    {name_uz:"Dubai Fistashka 110g", name_ru:"Дубай Фисташка 110г", emoji:"🟢", price:32000, badge:"Hit"},
    {name_uz:"Dubai Cono", name_ru:"Дубай Cono", emoji:"🟢", price:16800},
    {name_uz:"Eskimo Vanil 50g", name_ru:"Эскимо Ваниль 50г", emoji:"🤍", price:7000},
    {name_uz:"Eskimo Mango 50g", name_ru:"Эскимо Манго 50г", emoji:"🥭", price:7000},
    {name_uz:"Eskimo Marakuya 50g", name_ru:"Эскимо Маракуя 50г", emoji:"🍐", price:7000},
    {name_uz:"Eskimo Shokolad 50g", name_ru:"Эскимо Шоколад 50г", emoji:"🍫", price:7000},
    {name_uz:"Eskimo Yagoda 38g", name_ru:"Эскимо Ягода 38г", emoji:"🫐", price:7000},
    {name_uz:"Eskimo Kokos 50g", name_ru:"Эскимо Кокос 50г", emoji:"🥥", price:65000},
  ]},
  { c:{name_uz:"Sorbet (Calippo 80g)", name_ru:"Сорбет Calippo 80г", emoji:"🧊"}, p:[
    {name_uz:"Sorbet Limon 80g", name_ru:"Сорбет Лимон 80г", emoji:"🍋", price:8500},
    {name_uz:"Sorbet Mango 80g", name_ru:"Сорбет Манго 80г", emoji:"🥭", price:8500},
    {name_uz:"Sorbet Marakuya 80g", name_ru:"Сорбет Маракуя 80г", emoji:"🍐", price:8500},
    {name_uz:"Sorbet Qovun 80g", name_ru:"Сорбет Дыня 80г", emoji:"🍈", price:8500},
    {name_uz:"Sorbet Klubnika 80g", name_ru:"Сорбет Клубника 80г", emoji:"🍓", price:8500},
    {name_uz:"Sorbet Cola 80g", name_ru:"Сорбет Кока-кола 80г", emoji:"🥤", price:8500},
    {name_uz:"Sorbet Tutti Frutti 80g", name_ru:"Сорбет Тутти Фрутти 80г", emoji:"🌈", price:8500},
    {name_uz:"Sorbet Fanta 80g", name_ru:"Сорбет Фанта 80г", emoji:"🍊", price:8500},
    {name_uz:"Bubble Gum 80g", name_ru:"Бабл Гам 80г", emoji:"🩷", price:8500},
  ]},
  { c:{name_uz:"Stakanchik 120ml", name_ru:"Стаканчик 120мл", emoji:"🍨"}, p:[
    {name_uz:"Stakan Sliv. (vanil) 120ml", name_ru:"120мл Сливочное", emoji:"🤍", price:8850},
    {name_uz:"Stakan Banan 120ml", name_ru:"120мл Банановое", emoji:"🍌", price:8850},
    {name_uz:"Stakan Klubnika 120ml", name_ru:"120мл Клубничное", emoji:"🍓", price:8850},
    {name_uz:"Stakan Shokolad 120ml", name_ru:"120мл Шоколадное", emoji:"🍫", price:8850},
    {name_uz:"Stakan Yagoda 120ml", name_ru:"120мл Ягодное", emoji:"🫐", price:8850},
    {name_uz:"Stakan Mango 120ml", name_ru:"120мл Манго", emoji:"🥭", price:8850},
    {name_uz:"Stakan Limon 120ml", name_ru:"120мл Лимон", emoji:"🍋", price:8850},
    {name_uz:"Stakan Marakuya 120ml", name_ru:"120мл Маракуя", emoji:"🍐", price:8850},
  ]},
  { c:{name_uz:"Karton 0.5kg", name_ru:"Картон 0.5кг", emoji:"🥡"}, p:[
    {name_uz:"Karton Sliv. 0.5kg", name_ru:"Картон Сливочное 0.5кг", emoji:"🤍", price:37000},
    {name_uz:"Karton Banan 0.5kg", name_ru:"Картон Банан 0.5кг", emoji:"🍌", price:37000},
    {name_uz:"Karton Shokolad 0.5kg", name_ru:"Картон Шоколадное 0.5кг", emoji:"🍫", price:37000},
    {name_uz:"Karton Yagoda 0.5kg", name_ru:"Картон Ягодное 0.5кг", emoji:"🫐", price:37000},
  ]},
  { c:{name_uz:"To'plam / Quti", name_ru:"Набор / Коробка", emoji:"🎁"}, p:[
    {name_uz:"Cono Fruity Pop", name_ru:"Cono Fruity Pop", emoji:"🍬", price:49000, badge:"Hit"},
    {name_uz:"Sorbet 38g Limonchello (10 dona)", name_ru:"Сорбет 38г Лимончелло (10шт)", emoji:"🍋", price:65000},
    {name_uz:"Sorbet 38g Mango (10 dona)", name_ru:"Сорбет 38г Манго (10шт)", emoji:"🥭", price:65000},
    {name_uz:"Sorbet 38g Passion Fruit (10 dona)", name_ru:"Сорбет 38г Пассион Фрут (10шт)", emoji:"🍐", price:65000},
  ]},
  { c:{name_uz:"Bon-Bon", name_ru:"Бон-Бон", emoji:"🍡"}, p:[
    {name_uz:"Bon-Bon Banan", name_ru:"Бон-Бон Банан", emoji:"🍌", price:55000},
    {name_uz:"Bon-Bon Baunti", name_ru:"Бон-Бон Баунти", emoji:"🥥", price:55000},
    {name_uz:"Bon-Bon Klubnika", name_ru:"Бон-Бон Клубника", emoji:"🍓", price:55000},
    {name_uz:"Bon-Bon Ferrero-roshe", name_ru:"Бон-Бон Фереро-роше", emoji:"🍫", price:55000},
    {name_uz:"Bon-Bon Fistashka", name_ru:"Бон-Бон Фисташка", emoji:"🟢", price:60000},
    {name_uz:"Bon-Bon New Banan", name_ru:"Бон-Бон New Банан", emoji:"🍌", price:28800},
    {name_uz:"Bon-Bon New Kokos", name_ru:"Бон-Бон New Кокос", emoji:"🥥", price:36000},
    {name_uz:"Bon-Bon New Limon", name_ru:"Бон-Бон New Лимон", emoji:"🍋", price:28800},
    {name_uz:"Bon-Bon New Klubnika", name_ru:"Бон-Бон New Клубника", emoji:"🍓", price:28800},
    {name_uz:"Bon-Bon New Kivi", name_ru:"Бон-Бон New Киви", emoji:"🥝", price:28800},
  ]},
  { c:{name_uz:"Maxsus desert", name_ru:"Спец. десерт", emoji:"🍰"}, p:[
    {name_uz:"Cono Ice Cream Can 210g", name_ru:"Cono Ice Cream Can 210г", emoji:"🥫", price:40000},
    {name_uz:"Cono KFC Banan 200g", name_ru:"Cono KFC Банан 200г", emoji:"🍗", price:42000},
    {name_uz:"Cono KFC Klubnika 200g", name_ru:"Cono KFC Клубника 200г", emoji:"🍗", price:42000},
    {name_uz:"Cono KFC Sliv. 200g", name_ru:"Cono KFC Сливочное 200г", emoji:"🍗", price:42000},
  ]},
  { c:{name_uz:"Ichimlik (Yogurt)", name_ru:"Напитки (Йогурт)", emoji:"🥤"}, p:[
    {name_uz:"Yogurt Klubnika", name_ru:"Йогурт Клубника", emoji:"🍓", price:20000},
    {name_uz:"Yogurt Mango", name_ru:"Йогурт Манго", emoji:"🥭", price:20000},
    {name_uz:"Yogurt Shaftoli", name_ru:"Йогурт Персик", emoji:"🍑", price:20000},
  ]},
  { c:{name_uz:"Shirinliklar", name_ru:"Сладости", emoji:"🍬"}, p:[
    {name_uz:"Uzbekistan Sweets (assorti)", name_ru:"Uzbekistan (ассорти)", emoji:"🎁", price:150000, badge:"Lux"},
  ]},
];
...
function loadImport(){
  const blocks = CATALOG.map((blk,ci)=>{
    const rows = blk.p.map((pr,pi)=>`
      <div class="imp-row" data-imp data-ci="${ci}" data-pi="${pi}">
        <input type="checkbox" class="imp-check" checked>
        <span class="imp-emoji">${pr.emoji||"🍦"}</span>
        <span class="imp-name">${esc(pr.name_uz)}</span>
        <input type="number" inputmode="numeric" class="imp-price" value="${pr.price||''}" placeholder="narx">
      </div>`).join("");
  ...
  setPage(`
    ...
    <div class="panel" style="background:var(--cone-soft);box-shadow:none">
      <div style="font-size:13px;line-height:1.6;color:#7A5C1E">
        Narxlar <b>oldindan to'ldirilgan</b> (rasmiy ro'yxat asosida). Tekshiring,
        kerak bo'lsa o'zgartiring va <b>"Import qilish"</b>ni bosing. Belgini olib,
        kerakmas mahsulotni o'tkazib yuborasiz. Narxni bo'sh qoldirsangiz — qoralama bo'ladi.
      </div>
    </div>
    <button class="btn ghost block" style="margin-bottom:12px;color:var(--danger);border-color:var(--danger-soft)" onclick="clearCatalog()">🗑 Eski katalogni tozalash (qaytadan boshlash)</button>
    ${blocks}
...
async function runImport(){
  ...
  for(const ci of neededCats){
    ...
    done++; setBar(Math.round(done/totalSteps*100), `Kategoriya: ${c.name_uz}`);
  }
  ...
  openModal(`<h2>✅ Import tugadi!</h2>
    ...
    <p class="modal-sub">Endi har mahsulotga rasm qo'shing. Qoralama bo'lsa — narx qo'yib "Faol" qiling.</p>
    <button class="btn primary block" onclick="closeModal();go('products')">Mahsulotlarga o'tish</button>`);
}

/* ---- Katalogni tozalash (qaytadan boshlash uchun) ---- */
async function clearCatalog(){
  let cats, prods;
  try{ [cats,prods] = await Promise.all([api("/admin/categories"), api("/admin/products")]); }
  catch(e){ toast(e.message,"err"); return; }
  if(!cats.length && !prods.length){ toast("Katalog allaqachon bo'sh","ok"); return; }
  openModal(`
    <h2>⚠️ Katalogni tozalash</h2>
    <p class="modal-sub">Bu <b>${prods.length} mahsulot</b> va <b>${cats.length} kategoriya</b>ni butunlay o'chiradi.
    Buyurtmalar tarixi saqlanadi. Bu amalni qaytarib bo'lmaydi!</p>
    <button class="btn danger block" id="clrOk">Ha, hammasini o'chir</button>
    <button class="btn ghost block" style="margin-top:10px" onclick="closeModal()">Bekor qilish</button>
  `);
  document.getElementById("clrOk").onclick = ()=>doClear(prods, cats);
}
async function doClear(prods, cats){
  openModal(`<h2>Tozalanyapti…</h2>
    <p class="modal-sub">Iltimos kuting.</p>
    <div style="background:var(--cream);border-radius:12px;overflow:hidden;height:10px;margin:14px 0">
      <div id="clrBar" style="height:100%;width:0;background:var(--pink);transition:width .2s"></div></div>
    <div id="clrStatus" style="font-size:13px;color:var(--muted);text-align:center"></div>`);
  const setBar=(p,t)=>{ const b=document.getElementById("clrBar"); if(b)b.style.width=p+"%"; const s=document.getElementById("clrStatus"); if(s)s.textContent=t; };
  const total=prods.length+cats.length; let done=0, fail=0;
  for(const p of prods){ try{ await api("/admin/products/"+p.id,{method:"DELETE"}); }catch(e){ fail++; } done++; setBar(Math.round(done/total*100),"Mahsulotlar o'chirilyapti…"); }
  for(const c of cats){ try{ await api("/admin/categories/"+c.id,{method:"DELETE"}); }catch(e){ fail++; } done++; setBar(Math.round(done/total*100),"Kategoriyalar o'chirilyapti…"); }
  closeModal(); notify("success");
  openModal(`<h2>✅ Tozalandi!</h2>
    <p class="modal-sub">${fail?("Ba'zilari o'chmadi ("+fail+") — qayta urinib ko'ring. "):""}\nEndi pastdagi yangi katalogni narxlari bilan import qiling.</p>
    <button class="btn primary block" onclick="closeModal();go('import')">Importga qaytish</button>`);
}

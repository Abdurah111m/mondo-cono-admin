...
async function boot(){
  ...
  try{
    ...
    if(e.status===401) return gate("⏳","Sessiya eskirgan","Panelni yoping va botdan qaytadan oching.");
    return gate("⚠️","Ulanishda xato",(e.message||"Noma'lum xato")+". Backend uyg'onayotgan bo'lishi mumkin — bir oz kuting va qayta urinib ko'ring.");
  }
  buildShell();
  go("dash");
}
